    ...
    <div class="container-fluid">
        ...
        <div class="box_general padding_bottom">
            ...
            <div class="header_box version_2">
                  <h2><i class="fa fa-file"></i>Complaint Quick Search</h2>
            </div>
            <div class="row">
                  <div class="col-md-6">
            ...
            <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                            <label for="schDate">Complaint Date</label>
                            <input type="date" name="complainDate" id="complainDate" class="form-control" >
                      </div>
                  </div>
            </div>
          </div>
